...
#define CONTACTORS_STATES(X) \
    ...
    X(CONTACTORS_STATE_PRECHARGING_NEG, 1) \
    X(CONTACTORS_STATE_PRECHARGING, 2) \
    X(CONTACTORS_STATE_CLOSED, 3) \
    X(CONTACTORS_STATE_PRECHARGE_FAILED, 4) \
    X(CONTACTORS_STATE_TESTING_POS_OPEN, 5) \
    X(CONTACTORS_STATE_TESTING_POS_CLOSED, 6) \
    X(CONTACTORS_STATE_TESTING_NEG_OPEN, 7) \
    X(CONTACTORS_STATE_TESTING_NEG_CLOSED, 8) \
    X(CONTACTORS_STATE_TESTING_FAILED, 9) \
    X(CONTACTORS_STATE_CALIBRATING, 10) \
